    ...
    <div class="slider-wrapper">
      <div class="card-list swiper-wrapper">
        <div class="card-item swiper-slide">
          ...
          <a href="http://orcid.org/0000-0003-2631-4481" class="message-button" target="_blank">ORCID</a>
          <a href="https://github.com/TomMonks" class="message-button" target="_blank">GitHub</a>
        </div>
        <div class="card-item swiper-slide">
          ...
          <a href="https://orcid.org/0000-0002-6596-3479" class="message-button" target="_blank">ORCID</a>
          <a href="https://github.com/amyheather" class="message-button" target="_blank">GitHub</a>
        </div>
        <div class="card-item swiper-slide">
          ...
          <a href="https://orcid.org/0000-0001-5274-5037" class="message-button" target="_blank">ORCID</a>
          <a href="https://github.com/AliHarp" class="message-button" target="_blank">GitHub</a>
        </div>
        <div class="card-item swiper-slide">
          <img src="images/nav.jpeg" alt="User Image" class="user-image">
          <p class="user-name">Nav Mustafee</p>
          <p class="user-profession">Co-Investigator</p>
          <a href="https://orcid.org/0000-0002-2204-8924" class="message-button" target="_blank">ORCID</a>
          <a href="https://github.com/NavonilNM" class="message-button" target="_blank">GitHub</a>
        </div>
        <div class="card-item swiper-slide">
          <img src="images/andy.jpg" alt="User Image" class="user-image">
          <p class="user-name">Andy Mayne</p>
          <p class="user-profession">Co-Investigator</p>
          <a href="https://orcid.org/0000-0003-1263-2286" class="message-button" target="_blank">ORCID</a>
          <a href="https://github.com/andy-mayne" class="message-button" target="_blank">GitHub</a>
        </div>
      </div>
